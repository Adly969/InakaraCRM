...
import { Plus, Trash2, ArrowLeft, ShoppingBag, User, FileText, Calculator, ShieldCheck, Sparkles } from 'lucide-react';
...
export default function SalesOrderCreate() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        items: [{ description: 'Rangka Tempat Tidur Jati King (Grand Hyatt Hotel Series)', quantity: 10, unit: 'pcs', unit_price: 18500000 }] as FormItem[]
    });
    ...
    const handleAddPresetProduct = (name: string, price: number) => {
        setData('items', [
            ...data.items,
            { description: name, quantity: 1, unit: 'pcs', unit_price: price }
        ]);
    };
    ...
    return (
        <>
            <Head title="Buat Pesanan Penjualan (Sales Order)" />
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-neutral-200 dark:border-neutral-800 pb-5">
                    <div className="flex items-center gap-3">
                        <Button variant="outline" size="icon" asChild className="h-9 w-9 border-neutral-300 dark:border-neutral-700">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-50">
                                Buat Pesanan Penjualan Baru (Sales Order)
                            </h1>
                    ...
                    <div className="flex items-center gap-2">
                        <Button variant="outline" asChild className="border-neutral-300 dark:border-neutral-700">
                            <Link href={indexSalesOrdersRoute()}>Batal</Link>
                        </Button>
                        <Button onClick={handleSubmit} disabled={processing} className="bg-neutral-900 hover:bg-neutral-800 text-white dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-neutral-200 font-medium">
                            ...
                            <CardContent className="p-6 space-y-5">
                                ...
                                <div className="p-4 rounded-xl bg-neutral-100/70 dark:bg-neutral-800/50 border border-neutral-200/60 dark:border-neutral-750">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2.5">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => handleAddPresetProduct('Set Sofa Outdoor Weatherproof (Alila Resort Series)', 24500000)}
                                            className="px-3.5 py-1.5 rounded-full text-xs font-semibold bg-white dark:bg-neutral-800 border border-neutral-300/80 dark:border-neutral-700 text-neutral-800 dark:text-neutral-200 hover:border-neutral-400 hover:shadow-xs transition-all"
                                        >
                                            + Set Sofa Sunbrella (Rp 24,5Jt)
                                        </button>
                                    </div>
                                </div>
