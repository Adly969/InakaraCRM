...
import { index as indexWarehousesRoute, update as updateWarehouseRoute } from '@/routes/warehouses';
...
export default function WarehouseEdit({ warehouse, managers }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(updateWarehouseRoute(warehouse.id).url);
    };

    return (
        <>
            <Head title={`Edit Warehouse ${warehouse.code}`} />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-sm text-neutral-500 dark:text-neutral-400">
                            Modify physical storage location details.
                        </p>
                    </div>
                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex items-center space-x-2 pt-8">
                                    <Checkbox
                                        ...
                                        disabled={warehouse.is_default} // Cannot disable default warehouse directly
                                    ...
                                    <div className="grid gap-1.5 leading-none">
                                        ...
                                        <p className="text-xs text-neutral-500 dark:text-neutral-400">
                                            {warehouse.is_default 
                                                ? "This is the current default warehouse. You must mark another warehouse as default to change this."
