...
import { Plus, Trash2, ArrowLeft, FileCheck, User, Sparkles, ShoppingBag, FileText, Calculator, ShieldCheck } from 'lucide-react';
...
export default function QuotationCreate() {
    const { customers, leads, users } = usePage<PageProps>().props;
    const [relationType, setRelationType] = useState<'customer' | 'lead'>('customer');
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        items: [{ description: 'Penawaran Furnitur Jati Suite & Outdoor Villa', quantity: 1, unit: 'paket', unit_price: 185000000 }] as FormItem[]
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(QuotationController.store.url());
    };

    return (
        <>
            <Head title="Buat Surat Penawaran (Quotation)" />
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-neutral-200 dark:border-neutral-800 pb-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-neutral-50">
                                Buat Surat Penawaran Baru (Quotation)
                            </h1>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button onClick={handleSubmit} disabled={processing} className="bg-neutral-900 hover:bg-neutral-800 text-white dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-neutral-200 font-medium">
                            <FileCheck className="mr-2 h-4 w-4 text-sky-500" />
